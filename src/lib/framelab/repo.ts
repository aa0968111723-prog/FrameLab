...
export async function upsertWorkspaceSession(row: {
  ...
  await sql`
    update workspace_sessions set
      ...
      selected_character_id = ${row.selectedCharacterId !== undefined ? row.selectedCharacterId : existing.selected_character_id},
      selected_object_id = ${row.selectedObjectId !== undefined ? row.selectedObjectId : existing.selected_object_id},
