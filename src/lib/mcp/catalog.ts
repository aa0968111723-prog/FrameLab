...
export const MCP_TOOLS = [
  ...
  tool("annotate_frame", "Create a VisualAnnotation (POINT/REGION/PATH/LABEL/RANGE) with 0–1 coordinates. projectId optional when sessionId or timelineId is set.", { frameNumber: num, type: str, coordinates: { type: "array", items: num }, label: str, severity: str, x: num, y: num, w: num, h: num, sessionId: str, projectId: str, timelineId: str }),
  tool("highlight_region", "Highlight a normalized region on a frame. Frontend renders the box. projectId optional when sessionId or timelineId is set.", { frameNumber: num, x: num, y: num, w: num, h: num, label: str, severity: str, sessionId: str, projectId: str, timelineId: str }),
  tool("highlight_frame_range", "Highlight a frame range on the timeline. projectId optional when sessionId or timelineId is set.", { startFrame: num, endFrame: num, label: str, severity: str, sessionId: str, projectId: str, timelineId: str }),
