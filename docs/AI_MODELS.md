...
SAM 2 (`SegmentationProvider`), Video Depth Anything Small (`DepthProvider`), RIFE (`InterpolationProvider`), Wan (`GenerativeRepairProvider`), Qwen2.5-VL (spec VLM — v0.1 uses Grok instead), TensorRT (reserved).
